...
public record GeocodingCityData(String name, String administration, String country, double latitude, double longitude) {
	...
	public boolean equals(Object o) {
		...
		return Double.compare(latitude, that.latitude) == 0 && Double.compare(longitude, that.longitude) == 0 && Objects.equals(name, that.name) && Objects.equals(administration, that.administration) && Objects.equals(country, that.country);
	}
