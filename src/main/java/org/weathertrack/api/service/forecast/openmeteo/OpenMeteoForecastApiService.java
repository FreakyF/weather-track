...
import org.weathertrack.api.service.uri.builder.openmeteo.OpenMeteoApiParameterBuilder;
...
public class OpenMeteoForecastApiService implements ForecastApiService {
	...
	private URI buildForecastApiUri(GeocodingCityData geocodingCityData) {
		...
		return new OpenMeteoApiParameterBuilder.Builder()
				.setLatitude(latitude)
				.setLongitude(longitude)
				.setHourlyTemperature()
				.setHourlyRelativeHumidity()
				.setHourlyPrecipitation()
				.setHourlyWeatherCode()
				.setHourlySurfacePressure()
				.setHourlyWindSpeed()
				.setDailyMaxTemperature()
				.setDailyMaxPrecipitation()
				.setDailyWeatherCode()
				.setDailyMaxWindSpeed()
				.setAutoTimeZone()
				.buildURI(uriBuilder);
	}
}
