package org.weathertrack.input.service.userio.exception;

public class WeatherExceptionMessage {
	public static final String WEATHER_CONDITION_IS_NULL
			= "Tried to get forecast condition but the forecast condition is null!";
	public static final String WEATHER_CONDITION_IS_EMPTY
			= "Tried to get forecast condition but the forecast condition is empty!";
